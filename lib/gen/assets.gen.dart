...
class $LibGen {
  ...
  $LibContractsGen get contracts => const $LibContractsGen();
}
...
class $LibContractsGen {
  const $LibContractsGen();

  $LibContractsStagingGen get staging => const $LibContractsStagingGen();
}

class $LibContractsStagingGen {
  const $LibContractsStagingGen();

  /// File path: lib/contracts/staging/greeter.abi.json
  String get greeterAbi => 'lib/contracts/staging/greeter.abi.json';

  /// List of all assets
  List<String> get values => [greeterAbi];
}
